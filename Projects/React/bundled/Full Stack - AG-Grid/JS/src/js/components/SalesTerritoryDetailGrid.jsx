    ...
    render() {
        ...
        return (
            <div className="full-width-panel">
                ...
                {this.state.parentRecord.detailRecords.map((detailRecord) =>
                    <div class="col-lg-12" key={detailRecord.ID}>
                        <div class="col-lg-3">
                            ...
                            <div className="full-width-detail">{detailRecord.Person.Photo}</div>
        ...
        return (
            ...
            // <RepeaterComponent content={this.state.parentRecord.detailRecords} component={SalesTerritoryDetailGridTemplate} config={this.myComponentProps}></RepeaterComponent> 
