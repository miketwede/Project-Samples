...
using SampleDemoAspNetCore.Global;
using SampleDemoAspNetCore.Models;

using System.Drawing;

namespace SampleDemoAspNetCore.DAL
{
	public class CustomerDO
	{
		...
		private string connectionString = "Data Source=MIKES-PC;Initial Catalog = AdventureWorks2014; Integrated Security = true";
