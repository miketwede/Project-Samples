...
export default class SalesTerritoryMasterGrid extends Component {
    ...
    openModal() {
        if (!jQuery.isEmptyObject(this.state.currentRecord) ){
   ...
   // this.state.currentRecord = {};
    ...
    handleInputChange(event) {
        ...
        console.log("this.state.currentRecord.SalesLastYear", this.state.currentRecord.SalesLastYear);
    ...
    handleSubmit(event) {
      ...
      this.setState({currentRecord: {    
        SalesLastYear:   common.unFormatCurrency(SalesLastYear),
        SalesYTD:   common.unFormatCurrency(SalesYTD),
        CostLastYear:   common.unFormatCurrency(CostLastYear),
        CostYTD:   common.unFormatCurrency(CostYTD)        
    }
});

console.log("this.state.currentRecord", this.state.currentRecord); 

/*       //this.state.currentRecord.SalesLastYear = common.unFormatCurrency(this.state.SalesLastYear);
      this.state.currentRecord.SalesYTD = common.unFormatCurrency(this.state.SalesYTD);
      this.state.currentRecord.CostLastYear = common.unFormatCurrency(this.state.CostLastYear);
      this.state.currentRecord.CostYTD = common.unFormatCurrency(this.state.CostYTD);
      console.log("this.state.currentRecord", this.state.currentRecord); */
      ...
      saveSalesTerritory(this.state.currentRecord)
 ...
 // throw new Error(error);
  throw error;
    ...
    onRowSelected(params) {
        ...
        //this.state.currentRecord = params.data;
        this.setState({currentRecord: params.data});
    ...
    render() {
        ...
        //this.setState({currentRecord: this.state.rowData[0]});
             ...
             {/* <div  className="ag-fresh"> */}
                ...
                <Modal
                    ...
                    <form onSubmit={this.handleSubmit}>
                        ...
                        <label>
                        Group: {this.state.currentRecord != null && this.state.currentRecord.Group}
                        </label>

                        <br />

                        <label>
                        Country: {this.state.currentRecord != null && this.state.currentRecord.Country}
                        </label>

                        <br />

                        <label>
                        Region: {this.state.currentRecord != null && this.state.currentRecord.Region}
                        </label>
